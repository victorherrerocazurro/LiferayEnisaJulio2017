 ...
 * @generated
 */
public class ProductoLocalServiceClp implements ProductoLocalService {
    ...
    public ProductoLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName24 = "buscarProductosPorNombre";

        _methodParameterTypes24 = new String[] { "java.lang.String" };

        _methodName25 = "buscarProductosPorNombreAndPrecio";

        _methodParameterTypes25 = new String[] { "java.lang.String", "double" };
    }
    ...
    public com.example.plugins.model.Producto addProducto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(producto) });
        } catch (Throwable t) {
        ...
        return (com.example.plugins.model.Producto) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.example.plugins.model.Producto createProducto(long productoId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { productoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Producto deleteProducto(long productoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { productoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Producto fetchProducto(long productoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { productoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Producto getProducto(long productoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { productoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.example.plugins.model.Producto> getProductos(
        ...
        return (java.util.List<com.example.plugins.model.Producto>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public long altaProducto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(productoDto),
    ...
    public java.util.List<com.example.plugins.model.Producto> buscarProductosPorNombre(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    ...
                    new Object[] { ClpSerializer.translateInput(nombre) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.example.plugins.model.Producto> buscarProductosPorNombreAndPrecio(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    ...
                    new Object[] { ClpSerializer.translateInput(nombre), precio });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
