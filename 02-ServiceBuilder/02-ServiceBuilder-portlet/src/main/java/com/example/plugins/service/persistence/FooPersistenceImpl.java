...
import com.example.plugins.NoSuchFooException;
import com.example.plugins.model.Foo;
import com.example.plugins.model.impl.FooImpl;
import com.example.plugins.model.impl.FooModelImpl;
import com.example.plugins.service.persistence.FooPersistence;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
    ...
    @Override
    public Foo updateImpl(com.example.plugins.model.Foo foo)
        throws SystemException {
        foo = toUnwrappedModel(foo);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.example.plugins.model.Foo")));
